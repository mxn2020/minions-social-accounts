# Contributing to Minions Social-accounts

Thank you for your interest in contributing to Minions Social-accounts!

## Getting Started

1. Fork the repository
2. Clone your fork: `git clone https://github.com/YOUR_USERNAME/minions-social-accounts.git`
