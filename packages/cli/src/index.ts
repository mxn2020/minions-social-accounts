...
/**
 * @minions-social-accounts/cli — CLI for Minions Social-accounts
 *
...
import { customTypes } from '@minions-social-accounts/sdk';
...
program
    ...
    .action(() => {
        console.log(chalk.bold('Minions Social-accounts'));
        console.log(chalk.dim('Account definitions, platforms, namespaces/purposes, and API keys'));
        console.log('');
        console.log(`  SDK:    ${chalk.cyan('@minions-social-accounts/sdk')}`);
        console.log(`  CLI:    ${chalk.cyan('@minions-social-accounts/cli')}`);
        console.log(`  Python: ${chalk.cyan('minions-social-accounts')}`);
